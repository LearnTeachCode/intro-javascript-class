...
:point_right: **Next up:** [**let's test this out in the command line!**](https://github.com/LearnTeachCode/intro-javascript-class/blob/master/week-8/8-2-curl-intro.md)
